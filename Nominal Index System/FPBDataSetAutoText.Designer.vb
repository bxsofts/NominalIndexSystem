...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("FPBDataSetAutoText"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class FPBDataSetAutoText
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As FPBDataSetAutoText = CType(MyBase.Clone,FPBDataSetAutoText)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "FPBDataSetAutoText"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/FPBDataSetAutoText.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As FPBDataSetAutoText = New FPBDataSetAutoText()
    ...
    Partial Public Class profileDataTable
        ...
        Public Overloads Function AddprofileRow( _
                    ...
                    ByVal OV As Boolean) As profileRow
            Dim rowprofileRow As profileRow = CType(Me.NewRow,profileRow)
            Dim columnValuesArray() As Object = New Object() {TIN, RCN, Name, AliasN1, AliasN2, Sex, BirthYear, Address1, Address2, PCN, FathersName, AliasFathers1, HenryClass, Description, LatestTraceDate, OV}
...
Namespace FPBDataSetAutoTextTableAdapters
    ...
    Partial Public Class AutoTextAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `profile` (`TIN`, `RCN`, `Name`, `AliasN1`, `AliasN2`, `Sex`, `BirthY"& _ 
                ...
                "`, `Description`, `LatestTraceDate`, `OV`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,"& _ 
                " ?, ?, ?, ?, ?, ?)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT TIN, RCN, Name, AliasN1, AliasN2, Sex, BirthYear, Address1, Address2, PCN,"& _ 
                " FathersName, AliasFathers1, HenryClass, Description, LatestTraceDate, OV FROM p"& _ 
                "rofile"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT DISTINCT AliasN1"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         profile"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT DISTINCT AliasN2"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         profile"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(3) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(3).Connection = Me.Connection
            Me._commandCollection(3).CommandText = "SELECT DISTINCT FathersName"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         profile"
            Me._commandCollection(3).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(4) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(4).Connection = Me.Connection
            Me._commandCollection(4).CommandText = "SELECT DISTINCT AliasFathers1"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         profile"
            Me._commandCollection(4).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(5) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(5).Connection = Me.Connection
            Me._commandCollection(5).CommandText = "SELECT DISTINCT HenryClass"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         profile"
            Me._commandCollection(5).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(6) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(6).Connection = Me.Connection
            Me._commandCollection(6).CommandText = "SELECT distinct name from profile"
            Me._commandCollection(6).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(7) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(7).Connection = Me.Connection
            Me._commandCollection(7).CommandText = "SELECT     RCN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         profile"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (RCN = ?)"
            ...
            Me._commandCollection(8).CommandText = "SELECT TIN FROM profile where TIN=?"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As FPBDataSetAutoText.profileDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As FPBDataSetAutoText.profileDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As FPBDataSetAutoText.profileDataTable = New FPBDataSetAutoText.profileDataTable()
        ...
        Public Overloads Overridable Function FillByAlias1(ByVal dataTable As FPBDataSetAutoText.profileDataTable) As Integer
        ...
        Public Overloads Overridable Function GetDataBy1() As FPBDataSetAutoText.profileDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Dim dataTable As FPBDataSetAutoText.profileDataTable = New FPBDataSetAutoText.profileDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByAlias2(ByVal dataTable As FPBDataSetAutoText.profileDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy2() As FPBDataSetAutoText.profileDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            Dim dataTable As FPBDataSetAutoText.profileDataTable = New FPBDataSetAutoText.profileDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByFatherName(ByVal dataTable As FPBDataSetAutoText.profileDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy3() As FPBDataSetAutoText.profileDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(3)
            Dim dataTable As FPBDataSetAutoText.profileDataTable = New FPBDataSetAutoText.profileDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByFathersAlias(ByVal dataTable As FPBDataSetAutoText.profileDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy4() As FPBDataSetAutoText.profileDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(4)
            Dim dataTable As FPBDataSetAutoText.profileDataTable = New FPBDataSetAutoText.profileDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByHenry(ByVal dataTable As FPBDataSetAutoText.profileDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy5() As FPBDataSetAutoText.profileDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(5)
            Dim dataTable As FPBDataSetAutoText.profileDataTable = New FPBDataSetAutoText.profileDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByName(ByVal dataTable As FPBDataSetAutoText.profileDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy() As FPBDataSetAutoText.profileDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(6)
            Dim dataTable As FPBDataSetAutoText.profileDataTable = New FPBDataSetAutoText.profileDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByRCN(ByVal dataTable As FPBDataSetAutoText.profileDataTable, ByVal RCN As String) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(7)
            If (RCN Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(RCN,String)
            End If
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy7(ByVal RCN As String) As FPBDataSetAutoText.profileDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(7)
            If (RCN Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByTIN(ByVal dataTable As FPBDataSetAutoText.profileDataTable, ByVal TIN As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy6(ByVal TIN As String) As FPBDataSetAutoText.profileDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(8)
            If (TIN Is Nothing) Then
                Throw New Global.System.ArgumentNullException("TIN")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As FPBDataSetAutoText.profileDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As FPBDataSetAutoText) As Integer
        ...
        Public Overloads Overridable Function Insert( _
                    ...
                    ByVal OV As Boolean) As Integer
            If (TIN Is Nothing) Then
                Throw New Global.System.ArgumentNullException("TIN")
            Else
    ...
    Partial Public Class TableAdapterManager
        ...
        Private _autoTextAdapter As AutoTextAdapter
        ...
        Public Property AutoTextAdapter() As AutoTextAdapter
            Get
                Return Me._autoTextAdapter
            End Get
            Set
                Me._autoTextAdapter = value
            End Set
        End Property
        ...
        Public Property Connection() As Global.System.Data.IDbConnection
            Get
                If (Not (Me._connection) Is Nothing) Then
                    Return Me._connection
                End If
                If ((Not (Me._autoTextAdapter) Is Nothing)  _
                            AndAlso (Not (Me._autoTextAdapter.Connection) Is Nothing)) Then
                    Return Me._autoTextAdapter.Connection
                End If
                Return Nothing
            End Get
            Set
        ...
        Public ReadOnly Property TableAdapterInstanceCount() As Integer
            Get
                ...
                If (Not (Me._autoTextAdapter) Is Nothing) Then
                    count = (count + 1)
                End If
                Return count
            End Get
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As FPBDataSetAutoText, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            ...
            If (Not (Me._autoTextAdapter) Is Nothing) Then
                ...
                If ((Not (updatedRows) Is Nothing)  _
                    ...
                    result = (result + Me._autoTextAdapter.Update(updatedRows))
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As FPBDataSetAutoText, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._autoTextAdapter) Is Nothing) Then
                ...
                If ((Not (addedRows) Is Nothing)  _
                    ...
                    result = (result + Me._autoTextAdapter.Update(addedRows))
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As FPBDataSetAutoText, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._autoTextAdapter) Is Nothing) Then
                ...
                If ((Not (deletedRows) Is Nothing)  _
                    ...
                    result = (result + Me._autoTextAdapter.Update(deletedRows))
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As FPBDataSetAutoText) As Integer
            ...
            End If
            If ((Not (Me._autoTextAdapter) Is Nothing)  _
                        AndAlso (Me.MatchTableAdapterConnection(Me._autoTextAdapter.Connection) = false)) Then
            ...
            Try 
                ...
                '
                If (Not (Me._autoTextAdapter) Is Nothing) Then
                    revertConnections.Add(Me._autoTextAdapter, Me._autoTextAdapter.Connection)
                    Me._autoTextAdapter.Connection = CType(workConnection,Global.System.Data.OleDb.OleDbConnection)
                    Me._autoTextAdapter.Transaction = CType(workTransaction,Global.System.Data.OleDb.OleDbTransaction)
                    If Me._autoTextAdapter.Adapter.AcceptChangesDuringUpdate Then
                        Me._autoTextAdapter.Adapter.AcceptChangesDuringUpdate = false
                        adaptersWithAcceptChangesDuringUpdate.Add(Me._autoTextAdapter.Adapter)
                    End If
                End If
                '
                '---- Perform updates -----------
            ...
            Finally
                ...
                End If
                If (Not (Me._autoTextAdapter) Is Nothing) Then
                    Me._autoTextAdapter.Connection = CType(revertConnections(Me._autoTextAdapter),Global.System.Data.OleDb.OleDbConnection)
                    Me._autoTextAdapter.Transaction = Nothing
                End If
